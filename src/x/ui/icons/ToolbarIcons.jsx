...
/* Save to disk (download arrow into tray) */
export function SaveToDiskIcon(props) {
  return (
...
/* Restore from disk (upload arrow from tray) */
export function RestoreFromDiskIcon(props) {
  return (
    <svg viewBox="0 0 24 24" class={props.class || "w-5 h-5"} fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
