...
function NewPostIcon(props) {
  // This SVG is from your request, cleaned up for use as a component.
  return (
    <svg viewBox="0 0 32 32" class={props.class || "w-5 h-5"} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
