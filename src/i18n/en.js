...
export default {
  ...
  "ipfs.diag.liveness.ok": "Successfully connected to IPFS API at {url}.",
  "ipfs.diag.liveness.error": "Failed to connect to the IPFS API at {url}. This usually means the IPFS daemon is not running, or there is a CORS issue.",
  "ipfs.diag.config.name": "Fetch Configuration",
  "ipfs.diag.config.ok": "Successfully retrieved IPFS configuration.",
  "ipfs.diag.config.error": "Could not fetch config. This is a CORS issue on your IPFS API.",
  "ipfs.diag.cors.name": "Gateway CORS Check",
  "ipfs.diag.cors.ok": "CORS origin '{origin}' is correctly configured.",
  "ipfs.diag.cors.error": "CORS origin '{origin}' is missing from the Gateway config.",
  "ipfs.diag.fetch.name": "Live Gateway Fetch",
  "ipfs.diag.fetch.ok": "Successfully fetched test CID from {url}. Setup is complete!",
  "ipfs.diag.fetch.errorFirewall": "Final test failed. Error: {error}. This could be a firewall issue on port 8080.",
