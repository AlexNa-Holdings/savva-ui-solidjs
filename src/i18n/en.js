...
export default {
  ...
  "buyburn.description": "The SAVVA platform provides numerous services for promoting published content. All the native PLS tokens collected for such services are accumulated in the Buy&Burn contract. This contract has only one function: it purchases SAVVA tokens on the exchange and then burns all the received SAVVA tokens. This process increases the price of SAVVA tokens and reduces their total supply.",
  ...
  "sacrifice.description": "The SAVVA platform features a perpetual sacrifice process, allowing you to demonstrate your support for free speech. By sacrificing PLS tokens, you contribute to the cause. Every week, the platform mints a new batch of SAVVA tokens and distributes them proportionally among those who have made sacrifices to uphold free speech.",
  "sacrifice.disclaimer": "By sacrificing your PLS tokens you acknowledge that you do not expect any work or services in return. Receiving SAVVA tokens through this process is not an investment; it is a testament to your support for free speech.",
