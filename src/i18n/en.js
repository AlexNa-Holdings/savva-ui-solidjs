...
export default {
  ...
  "npo.roles.delete.message": "Are you sure you want to delete this role?",
  "npo.roles.delete.title": "Delete Role",
  "npo.roles.edit.addPermission": "Add Permission",
  "npo.roles.edit.anyFunction": "Any Function",
  "npo.roles.edit.functions.placeholder": "Select functions",
  "npo.roles.edit.functionsLabel": "Functions",
  "npo.roles.edit.name": "Role Name",
  "npo.roles.edit.name.hint": "Choose a descriptive name.",
  "npo.roles.edit.name.placeholder": "Enter role name",
  "npo.roles.edit.permissions": "Permissions",
  "npo.roles.edit.specificFunctions": "Specific Functions",
  "npo.roles.edit.target": "Target",
  "npo.roles.edit.target.hint": "Specify the target for this role.",
  "npo.roles.edit.target.placeholder": "Select target",
  "npo.roles.edit.title.existing": "Edit Role",
  "npo.roles.edit.title.new": "New Role",
  "npo.roles.empty": "No roles available.",
  "npo.roles.permCount": "{count} Permissions",
  ...
  "settings.ai.details.baseUrl": "Base URL: %s",
  "settings.ai.details.model": "Model: %s",
  "settings.ai.details.provider": "Provider: %s",
  "settings.ai.details.tokenAudience": "Token Audience: %s",
  "settings.ai.details.tokenExpiry": "Token Expiry: %s",
  "settings.ai.details.tokenIssuer": "Token Issuer: %s",
  ...
  "npo.roles.edit.target.hint": "Paste any EVM address or pick a known SAVVA contract.",
  "npo.roles.edit.target.help": "Selecting a known contract fills the address automatically. You can override it with a custom address.",
  "npo.roles.edit.anyFunction": "Any function",
