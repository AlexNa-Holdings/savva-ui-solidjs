...
export default {
  ...
  "editor.publish.rights.errorInsufficientStake": "Insufficient staked balance. Required: {required} SAVVA, you have: {actual} SAVVA.",
  ...
  "editor.publish.steps.ipfs": "Upload Post",
  "editor.publish.steps.ipfs.help": "Saving data to IPFS",
  "editor.publish.steps.ipfs_publish": "Upload Descriptor",
  "editor.publish.steps.ipfs_publish.help": "Uploading post descriptor to IPF",
  ...
  "editor.publish.rights.errorConfig": "Could not retrieve the minimum staking requirement from the contract.",
 "editor.publish.rights.errorInsufficientStake": "Insufficient staked balance. Required: {required} SAVVA, you have: {actual} SAVVA.",
  "editor.publish.ipfs.errorNetworkOrTooLarge": "This post is too large to upload. If you want to post very large content please consider using your own PIN services.",
 "editor.publish.success": "Successfully published!",
  "editor.publish.publishing.title": "Publishing Post",
  "editor.publish.publishing.waitSignature": "Waiting for your signature in the wallet...",
