...
export default {
  ...
  "delete.confirm.message":
    "This will hide the content from view, but it cannot be removed from the blockchain. This action cannot be undone. Are you sure?",
  "delete.toast.error": "Failed to submit deletion transaction.",
  "delete.toast.success":
    "Deletion submitted. It will be hidden after the backend processes the transaction.",
  ...
  "editor.chapters.confirmDeleteMessage":
  ...
  "editor.files.confirmDeleteMessage":
    "Are you sure you want to delete this file?",
  "editor.files.confirmDeleteTitle": "Delete File",
  "editor.files.empty":
    "No files uploaded yet. Use the buttons above to add files to your post.",
  ...
  "editor.files.uploadModalPlaceholder":
  ...
  "editor.fullPreview.help":
    "This is a preview of how your post will look once published. Review it carefully before proceeding.",
  ...
  "editor.params.publishAsNew.help":
    "If checked, this will be published as a new post with an updated timestamp, appearing at the top of feeds.",
  ...
  "editor.publish.ipfs.errorNoServices":
    "Pinning is enabled, but no pinning services are configured. Please add and test a service in Settings.",
  ...
  "editor.publish.publishing.waitFinalize":
    "Publishing is being finalized on the blockchain...",
  "editor.publish.publishing.waitSignature":
    "Please confirm the transaction in your wallet.",
  "editor.publish.publishing.waitSignatureHelp":
    "If the wallet window doesn't appear, open your wallet extension to complete the signature.",
  "editor.publish.rights.errorConfig":
    "Could not retrieve the minimum staking requirement from the contract.",
  "editor.publish.rights.errorInsufficientStake":
    "Insufficient stake to publish.",
  ...
  "editor.publish.steps.check_rights.help":
    "Verifying your posting permissions",
  ...
  "editor.publish.validation.errorIncomplete":
  ...
  "profile.edit.connectWallet":
    "Please connect your wallet to edit the profile.",
  ...
  "profile.edit.name.confirmChangeMessage":
  ...
  "profile.edit.name.help.line1":
    "This is your unique short name. Once you have one you can have a short url to your profile in form of @name.",
  "profile.edit.name.help.line2":
    "Names are case insensitive, so upper and lower case characters are the same.",
  "profile.edit.name.help.line3":
    "Only English letters, digits, and the symbols '.' (dot) and '-' (dash) are allowed.",
  ...
  "profile.edit.sponsorValues.label":
  ...
  "profile.wallet.nftEarnings.description":
    "NFT owner's proceeds from post sponsors.",
  "profile.wallet.nftEarnings.title": "NFT Owner Earnings",
  "profile.wallet.pls.description":
    "The blockchain's main token. These tokens are required for paying transaction fees and other network operations.",
  "profile.wallet.reward.description":
    "Reward for staking, accrued periodically upon completion of donation rounds.",
  "profile.wallet.reward.title": "Reward",
  "profile.wallet.savva.description":
    "SAVVA transferable tokens. You can use them for sponsoring authors and other operations on the platform.",
  "profile.wallet.savva.title": "SAVVA",
  "profile.wallet.staked.description":
    "The amount of tokens staked by you on the platform. The more you stake, the more voting weight and rewards you get.",
  "profile.wallet.staked.title": "Staked",
  "profile.wallet.staking.title": "Staking",
  "profile.wallet.unstaked.available.desc":
    "Once your cooldown ends, these tokens can be withdrawn to your wallet.",
  ...
  "settings.pinning.confirmDelete.message":
    "Are you sure you want to remove this service configuration?",
  "settings.pinning.confirmDelete.title": "Delete Pinning Service",
  "settings.pinning.delete": "Delete",
  "settings.pinning.description":
    "Configure external pinning services to ensure your content remains available on IPFS. For each service, you need an API key and the URL of a public gateway that can access its content.",
  "settings.pinning.edit": "Edit",
  "settings.pinning.enable.help":
    "If enabled, you can publish posts without size limitations, but you are responsible for keeping the files available. If your pin services are not available, your posts will not be accessible to readers.",
  "settings.pinning.enable.label":
    "Store the content of my posts on my pin services",
  "settings.pinning.modal.addTitle": "Add Pinning Service",
  "settings.pinning.modal.apiKey.label": "API Key (JWT)",
  "settings.pinning.modal.apiUrl.placeholder":
    "https://api.pinata.cloud/pinning/pinJSONToIPFS",
  "settings.pinning.modal.editTitle": "Edit Pinning Service",
  "settings.pinning.modal.gatewayUrl.help":
    "A public gateway that can resolve CIDs pinned by this service.",
  "settings.pinning.modal.gatewayUrl.placeholder":
  ...
  "settings.pinning.test.details.${step}_error":
  ...
  "settings.pinning.test.errorDetails":
    "Please check the details and try again.",
  "settings.pinning.test.hide_details": "Hide Details",
  "settings.pinning.test.status.${props.step.status}":
  ...
  "wallet.stake.errors.insufficientBalance":
    "Amount exceeds your available SAVVA balance.",
  ...
  "wallet.unstake.notice":
    "Unstaking starts a cooldown. Your tokens will become claimable in {days} days.",
  ...
  "subscriptions.info":
    "The author will receive your staked tokens each week while they keep posting. You can cancel anytime. Amount for the next week is non-refundable.",
  "subscriptions.subscribe.title": "Subscribe",
  "subscriptions.current.title": "Current subscription",
  "subscriptions.current.amountPerWeek": "Weekly amount",
  "subscriptions.current.weeksLeft": "Weeks left: {n}",
