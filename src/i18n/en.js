...
export default {
  ...
  "wallet.unstaked.availableNow": "Available Now",
    "rightPane.npoList": "NPO List",
  "npo.list.title": "Non-Profit Organizations",
  "npo.list.onlyMine": "Show only my NPOs",
  "npo.list.col.address": "Address",
  "npo.list.col.name": "Name",
  "npo.list.col.members": "Members",
  "npo.list.col.confirmed": "Confirmed",
  "npo.list.empty": "No NPOs found.",
...
"npo.page.title": "NPO",
"npo.page.emptyPlaceholder": "NPO details page (coming next).",
